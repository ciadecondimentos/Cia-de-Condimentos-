...
router.post('/debug/seed-test-orders', async (req, res) => {
  try {
    ...
    const orders = [
      { customer_name: 'João Silva', customer_email: 'joao@email.com', customer_address: 'Rua A, 123', total: 250.50, payment_status: 'Pago', payment_method: 'PIX', frete: 15.00 },
      { customer_name: 'Maria Santos', customer_email: 'maria@email.com', customer_address: 'Rua B, 456', total: 380.75, payment_status: 'Pago', payment_method: 'Cartão', frete: 20.00 },
      { customer_name: 'Pedro Costa', customer_email: 'pedro@email.com', customer_address: 'Rua C, 789', total: 120.00, payment_status: 'Pendente', payment_method: 'Boleto', frete: 10.00 },
      { customer_name: 'Ana Oliveira', customer_email: 'ana@email.com', customer_address: 'Rua D, 321', total: 550.30, payment_status: 'Pago', payment_method: 'PIX', frete: 25.00 },
      { customer_name: 'Carlos Souza', customer_email: 'carlos@email.com', customer_address: 'Rua E, 654', total: 185.60, payment_status: 'Pendente', payment_method: 'Dinheiro', frete: 0.00 },
      { customer_name: 'Julia Rocha', customer_email: 'julia@email.com', customer_address: 'Rua F, 987', total: 420.00, payment_status: 'Pago', payment_method: 'Cartão', frete: 20.00 },
      { customer_name: 'Ricardo Lima', customer_email: 'ricardo@email.com', customer_address: 'Rua G, 147', total: 310.45, payment_status: 'Pago', payment_method: 'PIX', frete: 15.00 },
      { customer_name: 'Fernanda Dias', customer_email: 'fernanda@email.com', customer_address: 'Rua H, 258', total: 95.20, payment_status: 'Pendente', payment_method: 'Boleto', frete: 8.00 },
      { customer_name: 'Thiago Mendes', customer_email: 'thiago@email.com', customer_address: 'Rua I, 369', total: 725.00, payment_status: 'Pago', payment_method: 'PIX', frete: 30.00 },
      { customer_name: 'Camila Torres', customer_email: 'camila@email.com', customer_address: 'Rua J, 741', total: 210.15, payment_status: 'Pago', payment_method: 'Cartão', frete: 12.00 }
    ];
    ...
    for (let i = 0; i < orders.length; i++) {
      ...
      try {
        await db.query(
          `INSERT INTO orders (customer_name, customer_email, customer_address, total, payment_status, payment_method, frete, created_at) 
           VALUES ($1, $2, $3, $4, $5, $6, $7, $8)`,
          [order.customer_name, order.customer_email, order.customer_address, order.total, order.payment_status, order.payment_method, order.frete, createdDate]
        );
        inserted++;
